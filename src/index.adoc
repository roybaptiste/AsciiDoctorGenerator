...
[.card.education]
====
Dynatrace PowerUser - Formation officielle

[horizontal]
Formateur:: icon:user[] Ousmane DIALLO - Delivery Architect de Dynatrace
...
[.card.education]
====
Dynatrace - Du concept à l'expertise
...
[.card.education]
====
EMEA Grafana Partner BootCamp (international) - Formation officielle
