...
:exp1-desc-content: * **Strategic Audit & Consulting:** Led a 2-day on-site audit with the client to analyze the observability platform (PoC) and co-develop the roadmap for industrialization. \
...
:exp1-tech-3: Distributed Architecture
:exp1-tech-4: Prometheus (Remote Write, OTLP)
:exp1-tech-5: Kubernetes (DaemonSet, NetPol)
:exp1-tech-6: Sampling Strategy
:exp1-tech-7: Service Graphs & Exemplars
:exp1-tech-8: Security (JWT, PrometheusRules)
:exp1-tech-9: Consulting & Strategy
:exp1-tech-10: MinIO
:exp1-tech-11: IaC / GitOps
:exp1-tech-12: Performance Optimization
...
:exp2-desc-content: * **Oversaw a multi-environment Kubernetes (RKE2) platform:** responsible for administration, operational stability, incident resolution, and continuous optimization of performance, security, and resilience. \
...
:exp2-tech-6: High Availability
:exp2-tech-7: RabbitMQ
:exp2-tech-8: Longhorn
:exp2-tech-9: Security (WAF, NetPol)
:exp2-tech-10: RHEL
:exp2-tech-11: Nginx
:exp2-tech-12: Microservices Architecture
...
:exp3-desc-content: * Developed an observability demonstration platform (React/Python - FastAPI/Java - Quarkus). \
...
:exp4-desc-content: * Implemented observability in a Kubernetes (OpenShift) / Bare-metal / VM environment across various technologies (Java/Wildfly...). \
...
:exp4-tech-4: Ansible
:exp4-tech-5: Monaco
:exp4-tech-6: Automation
:exp4-tech-7: Technical Documentation
...
:exp5-desc-content: * Responsible for designing and deploying new modules and enhancements for a Delphi / Firebird application. \
...
:exp5-tech-5: CI/CD Pipeline
:exp5-tech-6:
:exp5-tech-7: Customer / Technical Support
:exp5-tech-8: Traefik
:exp5-tech-9:
...
:exp6-desc-content: * Adapted and optimized monolithic services into microservices using Docker containerization. \
...
:exp7-desc-content: * Developed native Android mobile applications (for Selfone and Crédit Agricole). \
...
:exp7-tech-2: Corporate Networking
:exp7-tech-3:
:exp7-tech-4: Technical Interventions
:exp7-tech-5: Android - Java – Bash - PHP - HTML - CSS
:exp7-tech-6:
:exp7-tech-7: Technical Hotline
:exp7-tech-8: Telnet
:exp7-tech-9:
...
:exp8-desc-content: * Administered, managed, and led a section of 300 members within a multi-gaming association of 2000 people. \
* Created the website.
:exp8-tech-label: *Technologies and Skills:*
:exp8-tech-1: Team Management
:exp8-tech-2: Web Development
:exp8-tech-3:
