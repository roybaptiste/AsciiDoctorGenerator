...
:exp1-tech-rows: |[.tag]#OpenTelemetry (Collector, Operator)# |[.tag]#Grafana Tempo# |[.tag]#Distributed Architecture# \
...
:exp7-tech-rows: |[.tag]#Help Desk# |[.tag]#Corporate Networking# | \
...
:exp8-tech-rows: |[.tag]#Team Management# |[.tag]#Web Development# | \
